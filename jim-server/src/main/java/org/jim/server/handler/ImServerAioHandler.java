...
public class ImServerAioHandler implements ServerAioHandler {
	...
	private static final Logger log = Logger.getLogger(ImServerAioHandler.class);
	 ...
	 * @return
	 * @throws Exception
	 * @author: Wchao 2016年11月18日 上午9:37:44
	 * 
	 */
	@Override
	...
	public Packet decode(ByteBuffer buffer, int limit, int position, int readableLength, ChannelContext channelContext)
		...
		if (imSessionContext == null) {
			...
			channelContext.setAttribute(Const.CHAT_QUEUE,
					new MsgQueueRunnable(channelContext, imGroupContext.getTimExecutor()));
		} else {
